...
cyclistic_2021<-read.csv(paste(path,"/2021/First_three_month_2021.csv",sep=''))
cyclistic_2022<-read.csv(paste(path,"/2022/First_three_month_2022.csv",sep=''))
...
# Create columns as follows: date, month weekday and season
...
#riprawdata$season <- ifelse (triprawdata$month %in% c('06','07','08'), "Summer",
# ifelse (triprawdata$month %in% c('09','10','11'), "Fall",
# ifelse (triprawdata$month %in% c('12','01','02'), "Winter",
#      ifelse (triprawdata$month %in% c('03','04','05'), "Spring", NA))))

# Checking the new created column and summary
head(cyclistic_2021)
...
#Removing negative values of Ride length, Ride Duration, Missing Start and End Station Names
